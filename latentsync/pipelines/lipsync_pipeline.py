...
class LipsyncPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
            ...
            with record_function("_Load mask"):
                device = self._execution_device
                mask_image = load_fixed_mask(height, mask_image_path)
                self.image_processor = ImageProcessor(height, device="cuda", mask_image=mask_image)
                self.set_progress_bar_config(desc=f"Sample frames: {num_frames}")

            with record_function("_houskeeping"):
            ...
            with record_function("_audio preprocessing"):
            ...
            for i in tqdm.tqdm(range(num_inferences), desc="Doing inference..."):
                ...
                with record_function("_diff loop"):
                ...
                with record_function("_decode in latents loop"):
            ...
            with record_function("_restore video"):
            ...
            write_video(os.path.join(temp_dir, "video.mp4"), np.stack(synced_video_frames, axis=0), fps=video_fps)
